...
Prefer Docker, the optional Wasm host, the optional edge fleet agent, or
compiling a smaller build from source? See [Installation](book/en/src/installation.md).
